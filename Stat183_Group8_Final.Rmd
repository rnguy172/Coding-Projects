...
ggplot(data, aes(x = fmale)) + # distribution of genders
            geom_bar(fill = "lightblue") +
            labs(title = "Gender Distribution", x = "Gender", y = "Count")


ggplot(data, aes(x = part)) + # distribution of genders
            geom_bar(fill = "lightblue") +
            labs(title = "Partner Distribution", x = "Partner", y = "Count")

ggplot(data, aes(x = psyt)) + # distribution of genders
            geom_bar(fill = "lightblue") +
            labs(title = "Psychotherapist Distribution", x = "Psychotherapist", y = "Count")

```

```{r}
#Exploring proportions in categorical variables
ggplot(data, aes(x = above_avg, fill = fmale)) +
        geom_bar(position = "fill") +
        labs(title = "Above Average Empathy by Gender")

ggplot(data, aes(x = above_avg, fill = part)) +
        geom_bar(position = "fill") +
        labs(title = "Above Average Empathy by Partner")

ggplot(data, aes(x = above_avg, fill = psyt)) +
        geom_bar(position = "fill") +
        labs(title = "Above Average Empathy by Psychotherapist")
```

```{r}
#Find logit of probabilities
...
```{r}
#Explore interaction
ggplot(data, aes(x = year, y = logit, color = fmale)) +
  geom_point() +
  geom_smooth(method = "loess") +
  labs(title = "Above Average Empathy vs Year by Gender", y = "Logit of Probability of Above Average Empathy")

ggplot(data, aes(x = year, y = logit, color = part)) +
  geom_point() +
  geom_smooth(method = "loess") +
  labs(title = "Above Average Empathy vs Year by Partner", y = "Logit of Probability of Above Average Empathy")

ggplot(data, aes(x = year, y = logit, color = psyt)) +
  geom_point() +
  geom_smooth(method = "loess") +
  labs(title = "Above Average Empathy vs Year by Psychotherapist", y = "Logit of Probability of Above Average Empathy")




ggplot(data, aes(x = physact, y = logit, color = fmale)) +
  geom_point() +
  geom_smooth(method = "loess") +
  labs(title = "Above Average Empathy vs Physical Activity by Gender", y = "Logit of Probability of Above Average Empathy")

ggplot(data, aes(x = physact, y = logit, color = part)) +
  geom_point() +
  geom_smooth(method = "loess") +
  labs(title = "Above Average Empathy vs Physical Activity by Partner", y = "Logit of Probability of Above Average Empathy")

ggplot(data, aes(x = physact, y = logit, color = psyt)) +
  geom_point() +
  geom_smooth(method = "loess") +
  labs(title = "Above Average Empathy vs Physical Activity by Psychotherapist", y = "Logit of Probability of Above Average Empathy")




ggplot(data, aes(x = health, y = logit, color = fmale)) +
  geom_point() +
  geom_smooth(method = "loess") +
  labs(title = "Above Average Empathy vs Health by Gender", y = "Logit of Probability of Above Average Empathy")

ggplot(data, aes(x = health, y = logit, color = part)) +
  geom_point() +
  geom_smooth(method = "loess") +
  labs(title = "Above Average Empathy vs Health by Partner", y = "Logit of Probability of Above Average Empathy")

ggplot(data, aes(x = health, y = logit, color = psyt)) +
  geom_point() +
  geom_smooth(method = "loess") +
  labs(title = "Above Average Empathy vs Health by Psychotherapist", y = "Logit of Probability of Above Average Empathy")
```
...
ggplot(data, aes(x = year, y = logit)) +
  ...
  labs(title = "Above Average Probability vs Time(Year)", y = "Logit of Probability of Above Average")


ggplot(data, aes(x = physact, y = logit)) +
  geom_point() +
  geom_smooth(method = "loess", color = "red") +
  labs(title = "Above Average Probability vs Physical Activity", y = "Logit of Probability of Above Average")


ggplot(data, aes(x = health, y = logit)) +
  geom_point() +
  geom_smooth(method = "loess", color = "red") +
  labs(title = "Above Average Probability vs Health Score", y = "Logit of Probability of Above Average")
```
...
ggplot(data, aes(x = year, y = logit)) +
  geom_point(alpha = 0) +
  geom_abline(data = samp_model_coef, aes(intercept = (Intercept),
                                          slope = year,
                                          colour = ID))+
  geom_abline(aes(intercept = fixef(model1)[1], slope = fixef(model1)[2]), lwd = 2, col = "red") + 
  labs(title = "Above Average Epathy Probability vs Year", y = "Logit of Probab. of Above Average Empathy")
```
